...
export default function LandingPage() {
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "Contemporary Waterproofing",
          description: "Advanced chemical bonding for flat and sloped roofs.",
          phoneOne: {
        ...
        },
        {
          ...
          description: "Enhancing rooflines with durable, premium materials.",
          phoneOne: {
        ...
        },
        {
          ...
          description: "Seamless waterproofing for modern luxury terraces.",
          phoneOne: {
      ...
      metrics={[
        {
          id: "1",
          value: "500+",
          description: "Successfully completed structures",
        },
        {
          id: "2",
          value: "4.9/5",
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/female-artist-studio_23-2148002201.jpg",
          alt: "Elena R.",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Yes, we provide up to 10-year warranties on all installations.",
        },
        {
          id: "2",
          title: "Which regions do you serve?",
          content: "We primarily serve Abuja, but cater to high-end projects nationwide.",
        },
        {
          id: "3",
          title: "How do I get a quote?",
          content: "Simply call us at +2349044157778 or contact us via our booking form.",
        },
      ]}
      ...
      columns={[
        ...
        },
        {
          ...
          items: [
            {
              label: "+2348144399246",
              href: "tel:+2348144399246",
            },
            {
              label: "+2349044157778",
              href: "tel:+2349044157778",
            },
          ],
        },
      ]}
